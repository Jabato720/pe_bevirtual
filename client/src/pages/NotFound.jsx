  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          <svg id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 914.28 256.16" className="h-16 w-auto mx-auto">
            <defs>
          ...
          <h1 className="mt-6 text-3xl font-extrabold text-gray-900">Página no encontrada</h1>
          <p className="mt-2 text-center text-sm text-gray-600">
            Lo sentimos, la página que estás buscando no existe.
          </p>
        </div>
        <div>
          <Link to="/dashboard" className="btn btn-primary w-full flex justify-center">
            Volver al Dashboard
          </Link>
        </div>
      </div>
